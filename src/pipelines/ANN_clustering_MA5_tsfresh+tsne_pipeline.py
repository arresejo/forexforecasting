...
from src.models.prediction import ANN_clustering_model
...
if __name__ == '__main__':
    ...
    metrics_df = ANN_clustering_model.run_model(feature_method=TSFRESH_TSNE, ma_windows_size=MA_WINDOW_SIZE, plotting=False)
